...
import com.federico.repository.CoinRespository;
...
public class CoinServiceImpl implements CoinService{
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try{
            ...
            coin.setCurrentPrice(marketData.get("cuurent_price").get("usd").asDouble());
            ...
            coin.setMarketCapChangePercentage24h(marketData.get("market_cap_change_perc_24h").asLong());
    ...
    public Coin findById(String id) throws Exception {
        Optional<Coin> optionalCoin = coinRespository.findById(id);
